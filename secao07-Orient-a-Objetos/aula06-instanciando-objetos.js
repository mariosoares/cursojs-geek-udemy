...
console.log('---Instanciação de Objetos - Forma 5 - Objeto a partir das nossas classes---');
...
p1.comer();
p1.beber(); console.log();

const fit = new Carro("Fit");
fit.imprimir(); console.log();

// Instanciação de Objetos - Forma 1

console.log('---Instanciação de Objetos - Forma 1---');
...
delete curso['preco']; //poderia utilizar a notação de ponto

console.log(curso);console.log();


// Instanciação de Objetos - Forma 2 - Objeto Literal
console.log('---Instanciação de Objetos - Forma 2 - Objeto Literal---')
const programa = {
    nome: 'Photoshop',
    preco: 8999.99,
    fabricante: {
...
//console.log(programa['fabricante']['filiais'].length); //notação de colchetes que retorna o mesmo resultado
...
console.log(programa.fabricante.filiais); console.log(); // undefined

//console.log(programa.fabricante.filiais.length);  // ReferenceError


// Instanciação de Objetos - Forma 3 - Objeto Literal
console.log('---Instanciação de Objetos - Forma 3 - Objeto Literal---');
const pessoa = {};
...
console.log(typeof(l1)); console.log();
